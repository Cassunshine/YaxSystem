...
export class FormulaFunctionImporter {
    static importCustomFunctions(instance, props, options) {
        const customFunctions = {
            ...
            fetchFromActor: (actorName, formula, fallbackValue = null) => {
                ...
                if (actor) {
                    ...
                    this.importCustomFunctions(instance, props, options);
                    return returnValue;
                }
        ...
        foundry.utils.mergeObject(instance, customFunctions);
        return instance;
    }
}
